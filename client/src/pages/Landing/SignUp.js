                    ...
                    <Card1>
                        ...
                        <Row className="mx-auto">
                            <Col className="px-4">
                                ...
                                <FormLabel className="text-left h5 pt-4 pb-2">Select "Create New Circle" to create a brand new Circle to share with others.</FormLabel>
                                <button
                            ...
                            <Col className="px-4">
                                <Card className="h-100" style={{border: "none"}}>
                                <FormLabel className="text-left h5 pt-4 pb-2">Select "Join Existing Circle" if you have been given an existing Circle Name and Code.</FormLabel>
                                <button
